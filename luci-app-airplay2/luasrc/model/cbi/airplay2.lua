...
m = Map("airplay2")
m.title = translate("AirPlay 2 Audio Player")
m.description = translate("AirPlay 2 is a simple and easy-to-use AirPlay audio player.")

m:section(SimpleSection).template  = "airplay2/airplay2_status"

s = m:section(TypedSection, "airplay2")
s.addremove = false
s.anonymous = true
